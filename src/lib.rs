// src/lib.rs
/*
 * Core library for AdvancedSpectral
 */
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AdvancedSpectral processing");
    
    let mut processor = AdvancedSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AdvancedSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AdvancedSpectralProcessor::new(false);
